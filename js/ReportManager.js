...
for (var i = tableHeaderRowCount; i < rowCount; i++) {
  ...
  var arr1= document.getElementById('fromDate').value.split('-');
  var arr2 = document.getElementById('toDate').value.split('-');
  var dd1=arr1[2];
  var mm1=arr1[1];
  var yy1=arr1[0];
  var dd2=arr2[2];
  ...
  var toDate = dd2+'/'+mm2+'/'+yy2;
  //fromDate=fromDate.replace(/\b0/g, '');
//  toDate=toDate.replace(/\b0/g, '');
  ...
  db.collection("users").get().then(function(querySnapshot) {
      querySnapshot.forEach(function(doc)
      {
          ...
          console.log(employee.registrationDate);
          console.log(compare(employee.registrationDate));
          if(compare(employee.registrationDate)==1)
          {
            var table = document.getElementById("dataTable");
            var row = table.insertRow(count);
            var cell = row.insertCell(0);
...
function compare(registrationDate)
{
  var reg=registrationDate.split('/');
  if ( (arr1[2]==reg[0] && parseInt(arr1[1]) == parseInt(reg[1]) && parseInt(arr1[0]) == parseInt(reg[2]))
 || (arr2[2]==(reg[0]) && parseInt(arr2[1]) == parseInt(reg[1]) && parseInt(arr2[0]) == parseInt(reg[2]) ))
  return 1;
  else if
  (
    ((parseInt(arr1[2]) <= parseInt(reg[0]) && parseInt(arr1[1]) <= parseInt(reg[1]) && parseInt(arr1[0]) <= parseInt(reg[2])) && (parseInt(arr2[2]) >= parseInt(reg[0]) && parseInt(arr2[1]) >= parseInt(reg[1]) && parseInt(arr2[0]) >= parseInt(reg[2])))
|| ((parseInt(arr1[2]) > parseInt(reg[0]) && parseInt(arr1[1]) < parseInt(reg[1]) && parseInt(arr1[0]) <= parseInt(reg[2])) && (parseInt(arr2[2]) < parseInt(reg[0]) && parseInt(arr2[1]) > parseInt(reg[1]) && parseInt(arr2[0]) >= parseInt(reg[2])))
|| ((parseInt(arr1[2]) > parseInt(reg[0]) && parseInt(arr1[1]) < parseInt(reg[1]) && parseInt(arr1[0]) <= parseInt(reg[2])) && (parseInt(arr2[2]) >= parseInt(reg[0]) && parseInt(arr2[1]) >= parseInt(reg[1]) && parseInt(arr2[0]) >= parseInt(reg[2])))
|| ((parseInt(arr1[2]) <= parseInt(reg[0]) && parseInt(arr1[1]) <= parseInt(reg[1]) && parseInt(arr1[0]) <= parseInt(reg[2])) && (parseInt(arr2[2]) < parseInt(reg[0]) && parseInt(arr2[1]) > parseInt(reg[1]) && parseInt(arr2[0]) >= parseInt(reg[2])))
|| ((parseInt(arr1[2]) > parseInt(reg[0]) && parseInt(arr1[1]) > parseInt(reg[1]) && parseInt(arr1[0]) < parseInt(reg[2])) && (parseInt(arr2[2]) < parseInt(reg[0]) && parseInt(arr2[1]) < parseInt(reg[1]) && parseInt(arr2[0]) > parseInt(reg[2])))
